...
define(["jsgui-lang-essentials", "fs", "jsgui-node-png", "jsgui-node-pixel-buffer", "jsgui-node-pixel-buffer-process", "../../image/build/Release/binding.node"], 
            ...
            jsgui_png.load_pixel_buffer_from_disk('./source/dice.png', function(err, pix_buf) {
                if (err) {
                    ...
                    */
                    ...
                    jsgui_png.save_rgba_pixel_buffer_to_disk(pix_buf2, './res/edge-blur-dice.png', function(err, res) {
